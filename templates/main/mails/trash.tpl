<div id = "mails_bar_toolbar" style="width: 100%;height: 50px;">
    <a class="button gray" style="margin: 10px;height:22px;" href="javascript:void(0);" id="ym_delete_email">{$ns.langManager->getPhraseSpan(475)}...</a>    
    <a class="button blue" style="margin: 10px;height:22px;" href="javascript:void(0);" id="ym_restore_email">{$ns.langManager->getPhraseSpan(478)}</a>
</div>
<div id = "mails_trash_body" style="width: 100%;background: #fff">
