ngs.AddRemoveServiceCompanyBranchAction = Class.create(ngs.AbstractAction, {
    initialize: function($super, shortCut, ajaxLoader) {
        $super(shortCut, "company", ajaxLoader);
    },
    getUrl: function() {
        return "do_add_remove_service_company_branch";
    },
    getMethod: function() {
        return "POST";
    },
    ...
    afterAction: function(transport) {
        ...
        if (data.status === "ok") {
            ...
            ngs.load("service_company_profile", {'selected_branch_id': data.selected_branch_id, "refresh":1});
        } else
        {
