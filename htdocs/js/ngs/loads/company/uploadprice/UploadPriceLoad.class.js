ngs.UploadPriceLoad = Class.create(ngs.AbstractLoad, {
    ...
    afterLoad: function() {
        ngs.UrlChangeEventObserver.setFakeURL("/upload");
        ...
        if ($('up_selected_company')) {
            $('up_selected_company').onchange = this.onSelectedCompanyChanged.bind(this);
        }
